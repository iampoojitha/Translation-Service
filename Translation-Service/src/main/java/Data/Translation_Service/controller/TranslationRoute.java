...
public class TranslationRoute {
    ...
    public ResponseEntity<Map<String, String>> getTranslation(@RequestBody List<String> translationKeys, @RequestHeader(name = "Language", required = false) String languageHeader) {
        try {
            ...
            return ResponseEntity.ok(translationService.getTranslation(translationKeys, languages));
        } catch(Exception e) {
